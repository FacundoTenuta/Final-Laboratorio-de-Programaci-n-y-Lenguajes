...
<html>
    ...
    <body>
        ...
        <div id="show-critica" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.critica}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.critica}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
